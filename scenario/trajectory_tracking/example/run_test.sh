...
for w in "${waypoints[@]}"; do
  for i in {1..5}; do
    ...
    echo sbatch -J $name -t 60 ../../../../../../hpc/srunpy.sh path_following_test_standard.py env_config.mode train env_config.name $name env_config.num_waypoints $w
    sbatch -J $name -t 60 ../../../../../../hpc/srunpy.sh path_following_test_standard.py env_config.mode train env_config.name $name env_config.num_waypoints $w
