...
def create_parser(parser_creator=None):
    ...
    required_named.add_argument(
        ...
        help="The algorithm or model to train. This may refer to the name "
             ...
             "tune registry.")
    required_named.add_argument(
        "--env", type=str, help="The gym environment to use.", default="dummy")  # not longer used
    parser.add_argument(
        "--no-render",
        default=False,
        action="store_const",
...
def run(args, parser):
    ...
    if not NREL:
        ...
        ### to this:
        #        from test_standard_carla_map import CarlaRoadEnv
        ...
        agent = cls(config, CarlaRoadEnv)  ## note order of params is different!
    #        agent.policy = agent.get_policy()  ### my bad: restored some code in "rollout()" that sets this
    ### Note, for some reason I had to call get_policy() to set the policy variable?!
    ### Otherwise no changes from "rollout.py"
    ...
    with RolloutSaver(
        ...
        rollout(agent, env, num_steps, num_episodes, saver,
