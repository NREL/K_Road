...
class ESBestCoordinatedOptimizer(CoordinatedOptimizer):
    ...
    def __init__(
        ...
        print('ESBestCoordinatedOptimizer::init', self._theta.size, noise_stdev, self.noise_stdev, candidates_per_iteration)
